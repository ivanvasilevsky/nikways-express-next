...
export default function PortfolioModal({ title, modalOff, slug }) {
  ...
  const eventProject = async () => {
    ...
    formData.append('categoryId', setSelectCategory)
    ...
    const response = await $host.post('/project', FormData)
        ...
        <div className="portfolio__modal__form">
          ...
          <>
            <div className="portfolio__modal__item double">
              ...
              <input onChange={(e)=>setPreview(e.target.files)} type="file" className="main__input file"/>
            </div>
            <div className="portfolio__modal__item double">
              <p className="main__input__label">Фон</p>
              <input onChange={(e)=>setBg(e.target.files)} type="file" className="main__input file"/>
            </div>
            <div className="portfolio__modal__item double">
          ...
          <>
            ...
            <div className="portfolio__modal__item">
              ...
              <input onChange={(e)=>setIdea(e.target.files)} type="file" className="main__input file"/>
            </div>
          </>
          }
        </div>
